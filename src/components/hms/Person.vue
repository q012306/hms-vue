            ...
            <el-table-column align="right">
                ...
                <template slot="header" slot-scope="scope">
                    <el-input type="text"
                              v-model="search"
                              size="mini"
                              placeholder="输入员工姓名关键字搜索" />
                </template>
                <template slot-scope="scope">
                    <el-button size="mini"
                               @click="editPerson(scope.row)">编辑</el-button>
                    <el-button size="mini"
                               type="danger"
                               @click="deletePerson(scope.row.sid)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
 export default {
    ...
    methods: {
        loadPersons () {
        this.axios.get('/persons').then(response => {
      ...
      deletePerson(sid) {
        this.$confirm('此操作将永久删除, 是否继续?', '提示', {
          ...
          type: 'warning'
            ...
            this.axios
              .post('/personsdelete', {sid: sid}).then(resp => {
